<?php
namespace Schwartz\WilliTraveling\NodeTypes\TypoScriptObjects;
 ...
 */
class EntryImplementation extends TemplateImplementation {
  ...
  public function initializeView(FluidView $view) {
    ...
    $view->assign('photos', $processedAssets);
  }
}
